...
const Header = () => {
    ...
    const user = {name:'KayJay', email:'KayJay@gmail.com'}
    const logout = ()=>{};
    ...
    >
        <div className="max-w-7xl mx=auto px-4 sm:px-6 lg:px-8 ">
            <div className="flex items-center  justify-between  h-16 lg:h-20">
                ...
                <div className=" hidden lg:flex gap-7  items-center space-x-4">
                    {isAuthenticated ?( 
                        <ProfileDropdown
                    ...
                    <>
                        <Link
                            ...
                            <Link
                            to = "/signup"
                            className="bg-gradient-to-r from-blue-950 to-blue-900 text-white py-2.5 px-6 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                            >
                            Sign Up 
                        </Link> 
                    </>
        ...
        {isMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="#features"
                    className="block px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 font-medium transition-colors duration-200"
                    >
                        Features
                    </a>
                    <a href="#testimonials"
