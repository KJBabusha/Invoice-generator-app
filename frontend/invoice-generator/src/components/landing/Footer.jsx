...
const SocialLink = ({href,children})=>{
    return(
        <a 
            href={href}
            className="w-10 h-10 bg-blue-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors duration-200"
            target="_blank"
  ...
  return (
    <footer className="bg-blue-950 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><FooterLink to="/contact">Get in Touch</FooterLink></li>
                    </ul>
                </div>
                <div>
            ...
            <div className="border-t border-gray-600 py-8 mt-16">
